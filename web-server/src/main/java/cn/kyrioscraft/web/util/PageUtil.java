...
import cn.kyrioscraft.data.model.dto.GridData ;
import cn.kyrioscraft.web.exception.ParameterIllegalException ;
...
public class PageUtil {
    ...
    public static GridData parsePage2Grid(Page page){
        if(page==null){
            return null;
        }
        long total = page.getTotal();
        GridData gridData = new GridData();
        gridData.setRows(page);
