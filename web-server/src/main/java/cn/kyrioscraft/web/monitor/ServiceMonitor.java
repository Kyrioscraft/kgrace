package cn.kyrioscraft.web.monitor;

import cn.kyrioscraft.web.exception.ServerInternalErrorException ;
...
public class ServiceMonitor {
     ...
     * under that.
     */
    @Pointcut("execution(* cn.kyrioscraft.service..*(..))")
     ...
     */
    @AfterThrowing(pointcut = "cn.kyrioscraft.web.monitor.ServiceMonitor.serviceLayer()", throwing = "e")
